...
import {
    ...
    Image, TouchableOpacity, ImageBackground, TouchableNativeFeedback
} from 'react-native';
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View style={{ marginRight: 20, borderRadius: styles.profile_img.borderRadius, borderColor: "#e2e2e2", borderWidth: 1 }}>
                    <TouchableOpacity>
                        <Image resizeMode="contain" source={require('../../assets/generic-profile-photo.png')} style={styles.profile_img} />
                    </TouchableOpacity>
                </View>
